...
class Water extends Mesh<BufferGeometry, ShaderMaterial> {
  constructor(geometry: BufferGeometry | undefined, options = {}) {
    super(geometry);
    ...
    this.onBeforeRender = function (renderer, scene, camera, geom, mat, group) {
      ...
      reflector.onBeforeRender(renderer, scene, camera, geom, mat, group);
      refractor.onBeforeRender(renderer, scene, camera, geom, mat, group);
