...
// import { ComponentProps, Dynamic, useThree } from "solid-three";
...
//       left: { value: -size().width / 2, step: 1 },
//       right: { value: size().width / 2, step: 1 },
//       bottom: { value: -size().height / 2, step: 1 },
//       top: { value: size().height / 2, step: 1 },
