import * as React, { ReactNode, useState, createEffect } from "solid-js";
...
export const Tree = (props: TreeProps) => {
  ...
  // For some reason the useState above default doesn't work, so createEffect is needed
  createEffect(() => {
    setOpen(open);
  }, [open]);
  ...
  const updateFocus = (
    ...
    const focusableNode =
      newNode.querySelector<HTMLLIElement>('[tabindex="-1"]');
    focusableNode?.focus();
