...
export class RoomDurableObject {
    ...
    constructor(state: DurableObjectState, env: Env) {
        ...
        router.get("/room/:roomCode/ws/host/:clientId", (ctx) => handler.joinWebSocketAsHost(ctx));
        router.get("/room/:roomCode/ws/peer/:clientId", (ctx) => handler.joinWebSocketAsPeer(ctx));
