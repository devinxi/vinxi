export default `/*! modern-normalize v1.0.0 | MIT License | https://github.com/sindresorhus/modern-normalize */
...
summary {
  margin: calc(-0.5rem - var(--border-width));
...
summary:focus {
  ...
  outline: none;
  box-shadow: 0 0 0.2rem 0.01rem var(--border-hover-color);
}
