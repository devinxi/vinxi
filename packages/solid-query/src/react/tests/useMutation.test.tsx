...
describe("useMutation", () => {
  ...
  it("should be able to reset `data`", async () => {
    function Page() {
      const { mutate, data = "", reset } = useMutation(() => Promise.resolve("mutation"));
  ...
  it("should be able to reset `error`", async () => {
    ...
    const { getByTestId, getByText, queryByTestId } = renderWithClient(queryClient, <Page />);
    ...
    expect(getByTestId("error").textContent).toBe("Expected mock error. All is well!");
  ...
  it("should be able to override the error callbacks when using mutateAsync", async () => {
    ...
    function Page() {
      const { mutateAsync } = useMutation(async (_text: string) => Promise.reject("oops"), {
        onError: async () => {
  ...
  it("should pass meta to mutation", async () => {
    ...
    const { getByText, queryByText } = renderWithClient(queryClientMutationMeta, <Page />);
