...
import * as coreModule from "../react-query/core";
...
describe("React hydration", () => {
  ...
  describe("ReactQueryCacheProvider with hydration support", () => {
    test("should hydrate new queries if queries change", async () => {
      ...
      await intermediateClient.prefetchQuery("string", () => dataQuery("should change"));
      await intermediateClient.prefetchQuery("added string", () => dataQuery("added string"));
