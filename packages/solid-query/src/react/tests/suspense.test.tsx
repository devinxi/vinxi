...
describe("useQuery's in Suspense mode", () => {
  ...
  it("should render the correct amount of times in Suspense mode", async () => {
    ...
    function Page() {
      ...
      return <button aria-label="toggle" onClick={() => setStateKey(queryKey())} />;
    }
    ...
    function Page() {
      ...
      return (
        <div>
          ...
          <React.Suspense fallback="Loading...">{show && <Component />}</React.Suspense>
        </div>
      );
    }
  ...
  it("should error catched in error boundary without infinite loop", async () => {
    ...
    function App() {
      const { reset } = useQueryErrorResetBoundary();
      return (
        <ErrorBoundary onReset={reset} fallbackRender={() => <div>error boundary</div>}>
          <React.Suspense fallback="Loading...">
            <Page />
          </React.Suspense>
        </ErrorBoundary>
