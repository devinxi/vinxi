...
import * as QueriesObserverModule from "../react-query/core";
...
describe("useQueries", () => {
  ...
  it("handles type parameter - tuple of tuples", async () => {
    ...
    function Page() {
      ...
      const result2 = useQueries<[[string, unknown, string], [string, unknown, number]]>([
        {
          queryKey: key1,
          queryFn: () => "string",
          select: a => {
  ...
  it("handles type parameter - tuple of objects", async () => {
    ...
    function Page() {
      ...
      const result2 = useQueries<
        [{ queryFnData: string; data: string }, { queryFnData: string; data: number }]
      >([
        {
          queryKey: key1,
          queryFn: () => "string",
