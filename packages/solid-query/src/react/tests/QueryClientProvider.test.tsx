...
import { QueryClient, QueryClientProvider, QueryCache, useQuery, useQueryClient } from "../..";
...
describe("QueryClientProvider", () => {
  ...
  describe("useQueryClient", () => {
    ...
    test("should not use window to get the context when contextSharing is true and window does not exist", () => {
      ...
      const windowSpy = jest.spyOn(window, "window", "get").mockImplementation(undefined);
