export declare const buttonGroup: import("@stitches/core/types/styled-component").CssComponent<never, {}, {}, import("@stitches/core/types/css-util").CSS<{}, {
    colors: {
        elevation1: string;
        elevation2: string;
        elevation3: string;
...
//# sourceMappingURL=StyledButtonGroup.d.ts.map