...
// const MonitorCanvas = function ({ initialValue }: ObjectProps) {
...
//   const [gradientTop, gradientBottom] = createMemo(() => {
//     return [
...
//   createEffect(() => () => cancelAnimationFrame(raf.current!), []);

//   return <canvas class={canvas()} ref={canvasRef} />;
// });
