...
export class MotionValue<V = any> {
   ...
   * `createEffect` hook. As it returns an unsubscribe function, this should be returned
   * from the `createEffect` function to ensure you don't add duplicate subscribers..
   *
   * ```jsx
